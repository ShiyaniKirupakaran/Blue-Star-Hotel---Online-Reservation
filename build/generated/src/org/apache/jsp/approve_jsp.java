...
public final class approve_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        ...
        if(request.getParameter("send") != null){
            ...
            m_subject=request.getParameter("subject");
             ...
             if(request.getParameter("message") !=null){
                 ...
                 m_subject=m_subject.concat(request.getParameter("subject"));
                m_subject =m_subject.concat("<h2>Booking Approved</h2>");
            }
      ...
      out.write("            <button type=\"submit\" class='btn btn-success' name=\"send\" onclick=\"displayResult()\">Submit</button>\n");
      out.write("    </div>\n");
      out.write("    </div>\n");
      out.write("    </div>\n");
      out.write("            \n");
