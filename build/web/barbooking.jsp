<%-- 
    Document   : barbooking
    Created on : Dec 1, 2018, 3:14:15 PM
    Author     : hp
--%>
    ...
    <body>
                                ...
                                <nav class="navbar navbar-default">
                                    ...
                                    <div class="collapse navigation navbar-collapse navbar-ex1-collapse remove-space">
                                        <ul class="list-unstyled nav1 cl-effect-10">
                                            ...
                                            <li><a data-hover="Rooms" href="roomBookling.html" ><span>Rooms</span></a></li>
                                            <li><a data-hover="Wedding Halls"  href="new1.html"><span>Wedding Hall</span></a></li>
                                            <li><a data-hover="Bar" class="active"><span>Bar</span></a></li>
        ...
        <%
           ...
           try{
                ...
                String query = "insert into barbooking(Name,Email,Phone,Address,Date,People,Comments,File,Status)values('"+name+"','"+email+"','"+phone+"','"+address+"','"+date+"','"+people+"','"+comment+"','"+file+"','New')";
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 width-50 width-set-50">
                            <div class="footer-details">
                                ...
                                <ul class="list-unstyled footer-links">
                                    ...
                                    <li><a href="new1.html">Wedding Halls</a></li>
